...
mixin _$ServiceInfo {
 ...
 String get name; ServiceStatus get status; String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServiceInfo&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'ServiceInfo(name: $name, status: $status, description: $description)';
}
...
@useResult
$Res call({
 String name, ServiceStatus status, String? description
});
...
as ServiceStatus,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  ServiceStatus status,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  ServiceStatus status,  String? description)  $default,) {final _that = this;
switch (_that) {
case _ServiceInfo():
return $default(_that.name,_that.status,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  ServiceStatus status,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _ServiceInfo() when $default != null:
return $default(_that.name,_that.status,_that.description);case _:
  return null;
...
class _ServiceInfo implements ServiceInfo {
  const _ServiceInfo({required this.name, required this.status, this.description});
  factory _ServiceInfo.fromJson(Map<String, dynamic> json) => _$ServiceInfoFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$ServiceInfoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServiceInfo&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status)&&(identical(other.description, description) || other.description == description));
}
